...
#fill parameters
locations_temp = f'$USERENT$notebook_pyfiles/dots_comb/Channel_CHANNEL_NUM/MMStack_Pos$POSNUM$/Threshold_{JOB_ID}/Dot_Locations/*'
...
triple_decode = True
output_temp = f'$USERENT$notebook_pyfiles/decoded/OPT_CHCHANNEL_NUM/MMStack_Pos{JOB_ID}'
